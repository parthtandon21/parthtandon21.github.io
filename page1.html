...
<tr>
  		<td style="text-shadow: 0 0 3px rgb(16, 17, 17),0 0 4px rgb(216, 226, 224);font-family: verdana;font-size:0.8cm ">enter name</td>
<td><input type="text"  name="name" required focus></br></td>
</tr>

<tr>
  		<td style="text-shadow: 0 0 3px rgb(16, 17, 17),0 0 4px rgb(216, 226, 224);font-family: verdana;font-size:0.8cm ">enter number</td>
<td><input type="text" name="number" required></br></td>
</tr>

<tr>
  		<td style="text-shadow: 0 0 3px rgb(16, 17, 17),0 0 4px rgb(216, 226, 224);font-family: verdana;font-size:0.8cm ">enter email</td>
